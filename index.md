...
<header class="hero">
    ...
    <div class="contact-info">
        ...
        <a href="https://scholar.google.com/citations?user=e7JYe3cAAAAJ" class="contact-item" target="_blank" rel="noopener">
            <svg class="contact-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
<section class="content-section" id="news">
    ...
    <h2>News</h2>
    <p class="section-intro">Latest research news and publications from this year. A complete list of publications and citations is on my <a href="https://scholar.google.com/citations?user=e7JYe3cAAAAJ" target="_blank" rel="noopener">Google Scholar profile</a>.</p>
