...
[arXiv link](https://arxiv.org/abs/2405.06424)  
...
The code & data for the paper are shared at [P-B-U Git Repo](https://github.com/SimaDidari/proxy_based_uncertainty)
...
Comprehensive evaluation frameworks for assessing language model performance on domain-specific tasks, including novel metrics for technical accuracy and coherence.

---

[← Optimization](optimization.md) | [Back to Home](index.md)